...
var game = new function () {
    ...
    function finishGame(win) {
        ...
        try {
			...
			strResultado="Puntuacion: " + puntuacionBase20 + "  Aciertos: " + correctAnsweredCount + " de " +  questionCount 
			...
			if(puntuacionBase20 >= 50)  SCOSetValue("completed", 1);
			//else  SCOSetValue("completed", 1);
